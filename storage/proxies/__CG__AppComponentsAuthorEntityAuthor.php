...
class Author extends \App\Components\Author\Entity\Author implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'isActive', 'playedCount', 'unsplashSearchQuery', 'songs', 'links', 'createdAt', 'updatedAt'];
        }
     ...
     * {@inheritDoc}
     */
    public function setPlayedCount(int $playedCount): \App\Components\Author\Entity\Author
    {

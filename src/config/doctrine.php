...
return [
    ...
    */
        ...
        'default' => [
            ...
            'paths' => [
                ...
                base_path('app/Components/Author/Entity'),
                base_path('app/Components/AuthorLink/Entity'),
                base_path('app/Components/ComponentData/Entity'),
                base_path('app/Components/Label/Entity'),
                base_path('app/Components/LabelLink/Entity'),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'logger' => env('DOCTRINE_LOGGER', $devMode ? LaravelDebugbarLogger::class : false),
    /*
    |--------------------------------------------------------------------------
    | Cache
    |--------------------------------------------------------------------------

...
use App\Components\DeerRadio\Http\Controllers\Api\LiveStream\DeerRadioLivestreamController;
    ...
    public function boot(RouteRegistrar $routeRegistrar) : void
    {
        Route::prefix('api/internal')
            ...
            ->group(function() use ($routeRegistrar) {
                $routeRegistrar->get('livestream/prepare', [DeerRadioLivestreamController::class, 'prepare']);
                $routeRegistrar->post('livestream/send-chat-message', [DeerRadioLivestreamController::class, 'sendChatMessage']);
